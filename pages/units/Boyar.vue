    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        ...
        <div class="n1">
          ...
          <ul>
            <li>訓練速度由原本的23/20(一般/精銳)秒，下修至15秒(含精銳)。</li>
            <li>更新檔36906起，速度由1.4下修至1.3，遠程防禦由1/2上升至2/3。</li>
          </ul>
        </div>
        <h3>趣事</h3>
        <div class="hrn1"></div>
        ...
        <div class="n1">
          ...
          >英文寫作boyar或bolyar,是<nuxt-link to="/techs/age/Feudal_Age"
            >封建時代</nuxt-link
          >保加利亞帝國、莫斯科大公國、基輔羅斯、瓦拉幾亞和摩爾多瓦的一個僅次於大公的貴族頭銜。由10-17世紀，在保加利亞、俄國和羅馬尼亞演變為表示僅次於沙皇的親王王子，加在姓氏前面是「采邑貴族」，在芬蘭寫作
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          <tr>
            ...
            >
              <div class="unititle" style="color: #fff">貴族鐵騎</div>
            </td>
          </tr>
          <tr>
            <td colspan="2">
          ...
          <tr>
            ...
            <td class="unit4">
              <img class="gg" src="~assets/New_Boyar.png" alt="" />精銳貴族鐵騎
            </td>
          </tr>
          <tr>
